...
export class ApClassesService {
  private readonly apClasses: ApClass[] = [
    { id: '1', name: 'AP Art History', scoreDistribution: [
    ...
    , difficulty: 3},
    { id: '2', name: 'AP Biology', scoreDistribution: [
    ...
    , difficulty: 4},
    { id: '3', name: 'AP Calculus AB', scoreDistribution: [
    ...
    , difficulty: 4},
    { id: '4', name: 'AP Calculus BC', scoreDistribution: [
    ...
    , difficulty: 5},
    { id: '5', name: 'AP Chemistry', scoreDistribution: [
    ...
    , difficulty: 5},
    { id: '6', name: 'AP Chinese Language & Culture', scoreDistribution: [
    ...
    , difficulty: 3},
    { id: '7', name: 'AP Comparative Government & Politics', scoreDistribution: [
    ...
    , difficulty: 3},
    { id: '8', name: 'AP Computer Science A', scoreDistribution: [
    ...
    , difficulty: 3},
    { id: '9', name: 'AP Computer Science Principles', scoreDistribution: [
    ...
    , difficulty: 2},
    { id: '10', name: 'AP English Language and Composition', scoreDistribution: [
    ...
    , difficulty: 3},
    { id: '11', name: 'AP English Literature and Composition', scoreDistribution: [
    ...
    , difficulty: 3},
    { id: '12', name: 'AP Environmental Science', scoreDistribution: [
    ...
    , difficulty: 3},
    { id: '13', name: 'AP European History', scoreDistribution: [
    ...
    , difficulty: 4},
    { id: '14', name: 'AP French Language & Culture', scoreDistribution: [
    ...
    , difficulty: 3},
    { id: '15', name: 'AP German Language & Culture', scoreDistribution: [
    ...
    , difficulty: 3},
    { id: '16', name: 'AP Human Geography', scoreDistribution: [
      { score: 5, percentage: 16.0 },
    ...
    , difficulty: 2},
    { id: '17', name: 'AP Italian Language & Culture', scoreDistribution: [
    ...
    , difficulty: 3},
    { id: '18', name: 'AP Japanese Language and Culture', scoreDistribution: [
    ...
    , difficulty: 3},
    { id: '19', name: 'AP Latin', scoreDistribution: [
    ...
    , difficulty: 4},
    { id: '20', name: 'AP Macroeconomics', scoreDistribution: [
    ...
    , difficulty: 2},
    { id: '21', name: 'AP Microeconomics', scoreDistribution: [
    ...
    , difficulty: 2},
    { id: '22', name: 'AP Music Theory', scoreDistribution: [
    ...
    , difficulty: 4},
    { id: '23', name: 'AP Physics 1: Algebra-Based', scoreDistribution: [
    ...
    , difficulty: 4},
    { id: '24', name: 'AP Physics 2: Algebra-Based', scoreDistribution: [
    ...
    , difficulty: 4},
    { id: '25', name: 'AP Physics C: Electricity & Magnetism', scoreDistribution: [
    ...
    , difficulty: 5},
    { id: '26', name: 'AP Physics C: Mechanics', scoreDistribution: [
    ...
    , difficulty: 5},
    { id: '27', name: 'AP Psychology', scoreDistribution: [
    ...
    , difficulty: 2},
    { id: '28', name: 'AP Research', scoreDistribution: [
    ...
    , difficulty: 3},
    { id: '29', name: 'AP Seminar', scoreDistribution: [
    ...
    , difficulty: 3},
    { id: '30', name: 'AP Spanish Language & Culture', scoreDistribution: [
    ...
    , difficulty: 3},
    { id: '31', name: 'AP Spanish Literature & Culture', scoreDistribution: [
    ...
    , difficulty: 4},
    { id: '32', name: 'AP Statistics', scoreDistribution: [
    ...
    , difficulty: 3},
    { id: '33', name: 'AP Studio Art: 2-D Design', scoreDistribution: [
      { score: 5, percentage: 11.5 },
    ...
    , difficulty: 3},
    { id: '34', name: 'AP Studio Art: 3-D Design', scoreDistribution: [
    ...
    , difficulty: 3},
    { id: '35', name: 'AP Studio Art: Drawing', scoreDistribution: [
    ...
    , difficulty: 3},
    { id: '36', name: 'AP U.S. Government & Politics', scoreDistribution: [
    ...
    , difficulty: 3},
    { id: '37', name: 'AP U.S. History', scoreDistribution: [
    ...
    , difficulty: 4},
    { id: '38', name: 'AP World History', scoreDistribution: [
    ...
    , difficulty: 4},
    { id: '39', name: 'AP Precalculus', scoreDistribution: [
